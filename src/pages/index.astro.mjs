...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const page = loadSourcePage("index.html");
...
}, "/home/guille/www/tictap/marketing/website/astro/src/pages/index.astro", void 0);

const $$file = "/home/guille/www/tictap/marketing/website/astro/src/pages/index.astro";
const $$url = "";
