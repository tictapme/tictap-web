...
- `page-en`: 49 pages
- `blog-single-es`: 34 pages
- `other`: 27 pages
- `page-es`: 22 pages
- `archive-en`: 20 pages
- `archive-es`: 19 pages
- `blog-single-en`: 17 pages
- `case-study-single-es`: 11 pages
- `case-study-single-en`: 6 pages
- `blog-pagination-es`: 3 pages
- `blog-archive-en`: 1 pages
- `blog-archive-es`: 1 pages
- `blog-pagination-en`: 1 pages
- `case-study-archive-en`: 1 pages
- `case-study-archive-es`: 1 pages
- `home-en`: 1 pages

## Shells

### header:10265|footer:31753|body:archive tag ast-desktop ast-separate-container ast-two-container ast-no-sidebar ast-header-custom-item-inside ast-full-width-primary-header ast-inherit-site-logo-transparent|single:none|lang:en

- Count: 17
- Header: 10265
- Footer: 31753
- Single template: none
- Page types: archive-en
- Sample routes: /en/tag/asset-traceability/, /en/tag/asset-traceability-en/, /en/tag/business-fairs/, /en/tag/digitization/, /en/tag/european-regulations/, /en/tag/european-regulations-10/, /en/tag/european-regulations-en-2/, /en/tag/facility-maintenance/, /en/tag/industria-en/, /en/tag/industry/

### header:9642|footer:31645|body:archive tag ast-desktop ast-separate-container ast-two-container ast-no-sidebar ast-header-custom-item-inside ast-full-width-primary-header ast-inherit-site-logo-transparent|single:none|lang:es

- Count: 10
- Header: 9642
- Footer: 31645
- Single template: none
- Page types: archive-es
- Sample routes: /tag/digitalizacion/, /tag/industria/, /tag/maintenance/, /tag/mantenimiento-de-instalaciones/, /tag/mantenimiento-de-instalaciones/page/2/, /tag/normativa-europea/, /tag/railway/, /tag/retail/, /tag/trazabilidad-de-activos/, /tag/vcards/

### header:9642|footer:10152|body:archive ast-desktop ast-separate-container ast-two-container ast-no-sidebar ast-header-custom-item-inside ast-full-width-primary-header ast-inherit-site-logo-transparent|single:none|lang:es
...
- Single template: none
- Page types: archive-es
- Sample routes: /author/alejandro/, /author/guillermu/, /author/maria/, /author/maria/page/2/, /author/maria/page/3/, /author/maria/page/4/, /author/maria/page/5/

### header:none|footer:none|body:|single:none|lang:es

- Count: 6
- Header: none
- Footer: none
- Single template: none
- Page types: blog-single-es, case-study-single-es, other
- Sample routes: /blog/marcaje-ce/, /blog/tecnologia-nfc-y-qr-en-operaciones-industriales/, /casos-de-exito/trazabilidad-del-material-rodante-de-trenes-tramvias-y-coches-para-alstom/, /contact/, /cookies-policy/, /privacy-policy/

### header:9642|footer:31645|body:archive category ast-desktop ast-page-builder-template ast-no-sidebar ast-header-custom-item-inside ast-full-width-primary-header ast-inherit-site-logo-transparent elementor-page-8333 elementor-template-full-width|single:none|lang:es

- Count: 4
- Header: 9642
- Footer: 31645
- Single template: none
- Page types: blog-archive-es, blog-pagination-es
- Sample routes: /blog/, /blog/page/2/, /blog/page/3/, /blog/page/4/

### header:10265|footer:10168|body:archive ast-desktop ast-separate-container ast-two-container ast-no-sidebar ast-header-custom-item-inside ast-full-width-primary-header ast-inherit-site-logo-transparent|single:none|lang:en
...
- Single template: none
- Page types: archive-en
- Sample routes: /en/author/maria/, /en/author/maria/page/2/, /en/author/maria/page/3/

### header:10265|footer:31753|body:archive category ast-desktop ast-page-builder-template ast-no-sidebar ast-header-custom-item-inside ast-full-width-primary-header ast-inherit-site-logo-transparent elementor-page-8487 elementor-template-full-width|single:none|lang:en

- Count: 2
- Header: 10265
- Footer: 31753
- Single template: none
- Page types: blog-archive-en, blog-pagination-en
- Sample routes: /en/blog/, /en/blog/page/2/

### header:none|footer:none|body:archive ast-desktop ast-separate-container ast-two-container ast-no-sidebar ast-header-custom-item-inside ast-full-width-primary-header ast-inherit-site-logo-transparent|single:none|lang:es
...
- Single template: none
- Page types: archive-es
- Sample routes: /author/alejandra/, /author/sara/

### header:10265|footer:10168|body:page page-id-15283 ast-desktop ast-page-builder-template ast-no-sidebar ast-header-custom-item-inside ast-full-width-primary-header ast-single-post ast-inherit-site-logo-transparent elementor-page-15283|single:none|lang:en
...
- Single template: none
- Page types: page-en
- Sample routes: /en/vehicle-maintenance/

### header:10265|footer:10168|body:page page-id-15385 ast-desktop ast-page-builder-template ast-no-sidebar ast-header-custom-item-inside ast-full-width-primary-header ast-single-post ast-inherit-site-logo-transparent elementor-page-15385|single:none|lang:en
...
- Single template: none
- Page types: page-en
- Sample routes: /en/gestion-de-coshh/

### header:10265|footer:10168|body:page page-id-19285 ast-desktop ast-page-builder-template ast-no-sidebar ast-header-custom-item-inside ast-full-width-primary-header ast-single-post ast-inherit-site-logo-transparent elementor-page-19285|single:none|lang:en
...
- Single template: none
- Page types: page-en
- Sample routes: /en/cookie-policy/

### header:10265|footer:10168|body:page page-id-21085 ast-desktop ast-page-builder-template ast-no-sidebar ast-header-custom-item-inside ast-full-width-primary-header ast-single-post ast-inherit-site-logo-transparent elementor-page-21085|single:none|lang:en
...
- Single template: none
- Page types: page-en
- Sample routes: /en/demo-gratuita-tictap-industry/

## Asset recommendations

- Header/footer base should be extracted around header `9642` and footer `31645` for Spanish, and header `10265` and footer `31753` for English.
- Blog archive and blog single are distinct shells and should not share one Astro layout.
- Favor local mirrored assets under `src/wp-content/...` instead of remote `https://www.tictap.me/...` references during migration.
