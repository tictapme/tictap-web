const fs = require('fs');
const file = 'astro/legacy-sources/en/index.html';
let html = fs.readFileSync(file, 'utf8');

const startIdx = html.indexOf('<style id="tt-ps-css">');
...
const replacement = `<div class="elementor-element elementor-element-0c7dfde e-con-full e-flex e-con e-parent" data-id="0c7dfde" data-element_type="container" data-e-type="container" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
		...
		<div class="elementor-element elementor-element-95e112d e-con-full e-flex e-con e-child" data-id="95e112d" data-element_type="container" data-e-type="container">
				...
				<div class="elementor-widget-container">
					<h2 class="elementor-heading-title elementor-size-default">Manage and optimise your work processes</h2>				</div>
				</div>
				</div>
		...
		<div class="elementor-element elementor-element-e093e0e e-con-full e-flex e-con e-child" data-id="e093e0e" data-element_type="container" data-e-type="container">
				...
				<div class="elementor-widget-container">
					<h2 class="elementor-heading-title elementor-size-default">Your assets and facilities fail when information is scattered.
</h2>				</div>
				</div>
				</div>
				...
				<div class="elementor-widget-container">
									<p>Duplicated tasks, incomplete evidence, unclosed inspections and documents spread across multiple systems hinder operational continuity and compliance.</p>								</div>
				</div>
					</div>
				</div>
		...
		<div class="elementor-element elementor-element-88918ff e-con-full e-flex e-con e-child" data-id="88918ff" data-element_type="container" data-e-type="container">
				...
				<div class="elementor-widget-container">
					<h2 class="elementor-heading-title elementor-size-default">TicTAP unifies everything that happens at each facility.
</h2>				</div>
				</div>
				</div>
				...
				<div class="elementor-widget-container">
									Every activity is recorded and linked to its corresponding asset, enabling precise oversight and frictionless operations.
								</div>
				</div>
					</div>
				</div>
				...
				<div class="elementor-widget-container">
					...
					<a class="elementor-button elementor-button-link elementor-size-sm elementor-animation-shrink" href="/en/contact/" id="see-how">
